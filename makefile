...
SOURCE_FILES := main.c drivers/uart.c drivers/xmem.c utils.c drivers/timer.c drivers/adc.c drivers/io.c drivers/spi.c fonts.c drivers/menu.c drivers/can.c drivers/controller.c
